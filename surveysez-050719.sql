...
surveysez-050719.sql
  ...
  FOREIGN KEY (SurveyID) REFERENCES sp19_surveys(SurveyID) ON DELETE CASCADE
...
DROP TABLE IF EXISTS sp19_responses_answers; 
DROP TABLE IF EXISTS sp19_responses;
DROP TABLE IF EXISTS sp19_answers;
DROP TABLE IF EXISTS sp19_questions;
DROP TABLE IF EXISTS sp19_surveys;
  
#all tables must be of type InnoDB to do transactions, foreign key constraints
CREATE TABLE sp19_surveys(
...
INSERT INTO sp19_surveys VALUES (NULL,1,'Our First Survey','Description of Survey',NOW(),NOW(),0,0); 

#foreign key field must match size and type, hence SurveyID is INT UNSIGNED
CREATE TABLE sp19_questions(
...
INSERT INTO sp19_questions VALUES (NULL,1,'Do You Like Our Website?','We really want to know!',NOW(),NOW());
INSERT INTO sp19_questions VALUES (NULL,1,'Do You Like Cookies?','We like cookies!',NOW(),NOW());
INSERT INTO sp19_questions VALUES (NULL,1,'Favorite Toppings?','We like chocolate!',NOW(),NOW());


CREATE TABLE sp19_answers(
...
FOREIGN KEY (QuestionID) REFERENCES sp19_questions(QuestionID) ON DELETE CASCADE
)ENGINE=INNODB;

INSERT INTO sp19_answers VALUES (NULL,1,'Yes','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,1,'No','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,2,'Yes','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,2,'No','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,2,'Maybe','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,3,'Chocolate','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,3,'Butterscotch','',NOW(),NOW(),0);
INSERT INTO sp19_answers VALUES (NULL,3,'Pineapple','',NOW(),NOW(),0);


CREATE TABLE sp19_responses(
...
INSERT INTO sp19_responses VALUES (NULL,1,NOW());


CREATE TABLE sp19_responses_answers(
...
FOREIGN KEY (ResponseID) REFERENCES sp19_responses(ResponseID) ON DELETE CASCADE
)ENGINE=INNODB;

INSERT INTO sp19_responses_answers VALUES (NULL,1,1,1);
INSERT INTO sp19_responses_answers VALUES (NULL,1,2,5);
INSERT INTO sp19_responses_answers VALUES (NULL,1,3,6);
INSERT INTO sp19_responses_answers VALUES (NULL,1,3,7);
INSERT INTO sp19_responses_answers VALUES (NULL,1,3,8);
