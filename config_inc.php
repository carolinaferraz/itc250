...
$sub_folder = 'itc250/app/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'carolinapferraz@gmail.com'); # Email of site support
define('PREFIX', 'sp19_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
